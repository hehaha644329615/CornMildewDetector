...
# 公共模块导入
<<<<<<< HEAD
from common_3cls.FasterRCNN_models.network_files.faster_rcnn_framework import FasterRCNN, FastRCNNPredictor
...
=======
from common_3cls.models.network_files.faster_rcnn_framework import FasterRCNN, FastRCNNPredictor
from common_3cls.models.network_files.rpn_function_focal import RegionProposalNetwork
from common_3cls.models.network_files.roi_head_focal import RoIHeads
from common_3cls.models.backbone import resnet50_fpn_backbone, MobileNetV2
from common_3cls.utils.draw_box_utils import draw_objs
...
def main():
    ...
    # 权重路径
<<<<<<< HEAD
    weights_path = os.path.join(cfg.SAVE_WEIGHT_DIR, "resNetFpn-model-14.pth")
=======
