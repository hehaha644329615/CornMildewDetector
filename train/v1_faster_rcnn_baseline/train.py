...
def main(args):
    ...
    # 用来保存coco_info的文件
    results_file = "/home/wuyou/桌面/玉米检测项目/CornMildewDetector/train/v1_faster_rcnn/results{}.txt".format(datetime.datetime.now().strftime("%Y%m%d-%H%M%S"))
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        torch.save(save_files, "/home/wuyou/桌面/玉米检测项目/CornMildewDetector/train/v1_faster_rcnn/save_weights/resNetFpn-model-{}.pth".format(epoch))
