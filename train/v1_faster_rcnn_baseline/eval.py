...
VAL_ROOT = "/home/wuyou/桌面/玉米检测项目/Three_Class_Data/VOC2012"
...
plt.title(f"Epoch 14 Confusion Matrix\n(CONF_THRESH = {CONF_THRESH}, IOU_MATCH_THRESH = {IOU_MATCH_THRESH})")
plt.colorbar()
...
lines = [
    f"==== Epoch 14 评价指标 (CONF_THRESH = {CONF_THRESH}, IOU_MATCH_THRESH = {IOU_MATCH_THRESH}) ====\n"
]
