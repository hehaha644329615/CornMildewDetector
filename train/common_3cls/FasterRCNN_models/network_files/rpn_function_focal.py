...
from .loss_focal import BinaryFocalLoss
...
class RegionProposalNetwork(torch.nn.Module):
    ...
    def compute_loss(self, objectness, pred_bbox_deltas, labels, regression_targets):
        ...
        # ========== 替换为二分类Focal Loss ==========
        focal_bce = BinaryFocalLoss(alpha=0.25, gamma=2.0)
        objectness_loss = focal_bce(objectness[sampled_inds], labels[sampled_inds])
        # # 计算目标预测概率损失
