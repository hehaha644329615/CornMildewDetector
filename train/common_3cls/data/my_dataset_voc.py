...
from common_3cls.MaskRCNN_utils.coco_utils import convert_to_coco_api
...
class VOCInstances(Dataset):
    def __init__(self, voc_root, year="2012", txt_name: str = "train.txt", transforms=None):
        ...
        image_dir = os.path.join(root, 'JPEGImages', 'JPEGImages')
        ...
        # read class_indict
        json_file = os.path.join(root, 'pascal_voc_classes.json')
