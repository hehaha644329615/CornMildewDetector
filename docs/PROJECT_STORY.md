...
### v3：YOLOv8n 基线
- 原本试想的是用同一份训练数据分别用FastRCNN和YOLOv8各跑一次，看看各自的精度如何再决定用精度高的框架。
...
| v3训练 | 指标 |
|:---|:---|
| ![alt text](images/v3_prodution/BoxF1_curve.png) | ![alt text](images/v3_prodution/BoxP_curve.png) | 
| ![alt text](images/v3_prodution/BoxPR_curve.png) | ![alt text](images/v3_prodution/BoxR_curve.png) |
| ![alt text](images/v3_prodution/confusion_matrix.png) | ![alt text](images/v3_prodution/labels.jpg) |
| ![alt text](images/v3_prodution/results.png)|
